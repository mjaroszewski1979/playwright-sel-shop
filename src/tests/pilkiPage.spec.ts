 ...
 */
test('Verify URL of Balls category page', async ({ mainPage, firstProductPage, pilkiPage }) => {
  await mainPage.goto();
 ...
 */
test('Verify title of Balls category page', async ({ mainPage, firstProductPage, pilkiPage }) => {
  await mainPage.goto();
  await mainPage.clickFirstProductLink();
  await firstProductPage.clickPilkiCategoryLink();
