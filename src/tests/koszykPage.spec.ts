 ...
 */
test('Verify Cart page URL', async ({ 
  mainPage,
  koszykPage
 }) => {
 ...
 */
test('Verify product removal from cart', async ({ 
  mainPage,
  firstProductPage,
  koszykPage,
 }) => {
 ...
 */
test('Verify adding product to cart using hover button', async ({ 
mainPage,
koszykPage,
}) => {
 ...
 */
test('Verify cart total amount updates after quantity change', async ({ 
mainPage,
koszykPage,
}) => {
