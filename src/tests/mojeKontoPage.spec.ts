 ...
 */
test('Verify URL of My Account page', async ({ mainPage, mojeKontoPage }) => {
  await mainPage.goto();
 ...
 */
test('Verify login process with valid credentials', async ({ mainPage, mojeKontoPage }) => {
  await mainPage.goto();
  await mainPage.gotoMojeKontoPage();
 ...
 */
test('Verify login process with invalid credentials', async ({ mainPage, mojeKontoPage }) => {
  await mainPage.goto();
  await mainPage.gotoMojeKontoPage();
 ...
 */
test('Verify logout process works correctly', async ({ mainPage, mojeKontoPage }) => {
  await mainPage.goto();
  await mainPage.gotoMojeKontoPage();
